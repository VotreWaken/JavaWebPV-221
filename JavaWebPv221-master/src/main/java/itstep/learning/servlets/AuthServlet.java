...
public class AuthServlet extends RestServlet {
    ...
    @Inject
    public AuthServlet(Logger logger, UserDao userDao, TokenDao tokenDao, RoleDao roleDao) {
        this.logger = logger;
    ...
    protected boolean CheckRight(UUID userId) {
            ...
            boolean hasRole = roleDao.hasRole(user.getId(), "Admin");
            return hasRole;
        }
}
